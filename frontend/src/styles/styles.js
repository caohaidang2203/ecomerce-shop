const styles = {
  ...
  active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[#3957db]",
  button:
    "w-[140px] bg-black h-[40px] my-3 flex items-center justify-center rounded-xl cursor-pointer",
  cart_button:
